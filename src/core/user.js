...
class User extends controller {
    ...
    async returnToken(req, res, result, type, mobileId) {
        ...
        let responseData = Object.assign({}, {
            ...
            "taker_fee": (result.taker_fee_detection_percentage) ? ((takerFee.value - (takerFee.value * Number(result.taker_fee_detection_percentage) / 100)) * 100).toFixed(2) : takerFee.value,
            "maker_fee": (result.maker_fee_detection_percentage) ? ((makerFee.value - (makerFee.value * Number(result.maker_fee_detection_percentage) / 100)) * 100).toFixed(2) : makerFee.value,
